...
\rowcolor{LightCyan}
	...
	\caption{\label{tab:DataStorage}Data Storage FMEA \\\hspace{0.1\textwidth} \textbf{Req:} \hyperref[SR1]{SR1}, \hyperref[SR5]{SR5}, \hyperref[DSR2]{DSR2}}
	\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\rowcolor{LightCyan}
			...
			\end{minipage}
			 ...
			 & \begin{minipage}[t]{\linewidth}
			   ...
			   \end{minipage}  \tabularnewline\cline{1-6}
		\end{tabular}%\vspace{3mm}
	\caption{\label{tab:Records}Record System FMEA \\\hspace{0.1\textwidth} \textbf{Req:} \hyperref[SR1]{SR1},\hyperref[SR2]{SR2}, \hyperref[SR5]{SR5}, \hyperref[DSR1]{DSR1},\hyperref[DSRQ1]{DSRQ1},\hyperref[DSRQ2]{DSRQ2}}
	\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\rowcolor{LightCyan}
			\textbf{Design Component} & \textbf{Failure Modes}    & \textbf{Causes of Failure} & \textbf{Effects of Failure} & \textbf{Detection} & \textbf{Recommended Action}					 						\tabularnewline\hline
			\multirow{20}{*}{\centering\rotatebox[origin=c]{90}{\hyperref [Configuration_sec] {Configuration system}}}
			 & Calibration fails                                                              &
			\begin{minipage}[t]{\linewidth}
				\begin{itemize}[nosep, wide=0pt, leftmargin=*, after=\strut]
		...
		\end{tabular}%\vspace{3mm}
	\caption{\label{tab:Calibration}Calibration System FMEA}
	\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{llX}
		\toprule
		\textbf{SNo.} & \textbf{Requirement} & \textbf{Expected date of implementation}        \\
		\midrule
		1         	& Name(s)               	& Description of changes \\
		2         	& Name(s)              	& Description of changes \\
		3          	& ...                   	& ...                   	     \\
		4		& ... 				& ... 				     \\	
		5		& ... 				& ...                               \\
		\bottomrule
