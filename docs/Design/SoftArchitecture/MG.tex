...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    \midrule
    R1            & \mref{mBM}, \mref{mSA}, \mref{mDS_2}, \mref{mRTC}                               \\
    R2            & \mref{mSA}, \mref{mMAA}                                                              \\
    R3            & \mref{mSA}, \mref{mDS_2}, \mref{mPG}, \mref{mRTC}, \mref{mMAA}                                                                             \\
    R4            & \mref{mPD}                                                    \\
    R5            & \mref{mPS} \\
    R6            & \mref{mDM}, \mref{mDS_1}, \mref{mSA}, \mref{mPG}\\
    R7            & \mref{mDM}, \mref{mDS_1}, \mref{mGP}             \\
    \bottomrule
  \end{tabular}
