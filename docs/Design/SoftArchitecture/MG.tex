...
\begin{description}
  ...
  \item [\refstepcounter{mnum} \mthemnum \label{mPS}:] Configuration Module
  \item [\refstepcounter{mnum} \mthemnum \label{mPD}:]  Watch Straps and Case Module
\end{description}
...
\begin{table}[h!]
  ...
  \begin{tabular}{|p{0.3\textwidth} | p{0.3\textwidth} |p{0.3\textwidth}  |}
    ...
    \multirow{7}{0.3\textwidth} {Hardware-Hiding Module}              & Battery Management       & Battery\\
\cline{2-3}
					                                                          &  \multirow{2}{0.3\textwidth}{Data Storage}        & microSD     \\
																		&			&Database\\
\cline{2-3}
					                                                          & \multirow{2}{0.3\textwidth}{Sensor Array}         & Sensor Reading    \\
...
\cline{2-3}
    ...
    \multirow{3}{0.3\textwidth}{Software Decision Module} &  Parameter selection & Configuration\\
\cline{2-3}
