...
Data Storage Module (Section \ref{mDS_1}), Moving Average Algorithm Module (Section \ref{mMAA}) %uses this module becuase the heartrate uses this module. 
...
Prompt Generation Module (Section \ref{mPG}), Real Time Clock Module (Section \ref{mRTC})
