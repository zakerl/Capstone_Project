...
\item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR5}:]
...
\item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR6}:]
...
\item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR7}:]
...
\item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR10}:]
