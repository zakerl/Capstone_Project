...
\item \textbf{Hardware}: 
	\begin{itemize}
		...
		\label{HC2}\item[HC2:] The system must have an average battery life of atleast 7 days to facilitate monitoring of the users.
...
\item \textbf{Software} :
	\begin{itemize}
		...
		\label{SC2}\item[SC2:] To maintain privacy, the system will only store data for two weeks after which the data will be deleted.
