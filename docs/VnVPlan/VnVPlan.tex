...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Device should stay on during the monitoring period - \textbf{R1}}
...
\begin{enumerate}
	...
	\item{DT\_3: Date beyond capabilities\\}
...
\subsubsection{Date should track Minor Movements - \textbf{R2}}
...
\begin{enumerate}
	...
	\item{MTT\_2: Slow Movement \\}
		...
		How test will be performed: The test is performed by strapping the device onto a test volunteer who will perform the tracked activities at very slow. This is done to ensure that the device can 						work under scenarios in which users have limited mobility.	
...
\subsubsection{Device is wearable - \textbf{R4}}
...
\begin{enumerate}
	\item{TT\_1: Regular Inputs \\}
		...
		Output: Config File generated succesfully.
...
\subsubsection{Data Storage - \textbf{R5}}
...
The following tests will be done to ensure that data is stored when appropriate. Tests include checking when storage buffer is full, when prompts are generated and when sensor data needs to be logged. 
	...
	\item{DST\_1: Storage Buffer Full \\}
