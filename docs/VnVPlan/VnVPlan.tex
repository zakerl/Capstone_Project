...
The SRS verification plan will follow a strict checklist for Functional and Non-functional requirements. The Non-functional requirements are important for SRS verification as requirements such as safety and comfort have to be taken into account for participants who will be wearing the device. The SRS verification plan will also involve an ad hoc feedback approach. This is to make sure all the requirements and goals receive several test-cases that could help with the SRS verification plan. 
