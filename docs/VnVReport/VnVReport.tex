...
\begin{enumerate}
  ...
  \end{itemize}
\newpage
  \textbf{Observed Results}: The UI was considered to be intuitive and user-friendly, testers were able to navigate through and answer propmpts without any problem. Below table lays out all the responses made by the four participating testers.

\begin{table}[H]\label{survey}
\centering
