...
"")
        ...
        spacerItem19 = QtWidgets.QSpacerItem(20, 38, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem19, 13, 2, 1, 1)
        spacerItem20 = QtWidgets.QSpacerItem(338, 28, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem20, 14, 0, 1, 2)
        self.ClearSDbtn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ClearSDbtn.sizePolicy().hasHeightForWidth())
        self.ClearSDbtn.setSizePolicy(sizePolicy)
        self.ClearSDbtn.setStyleSheet("font-size: 14pt;background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(254,79,78,255), stop:1 rgba(51,15,15,255));\n"
"font: 9pt \"Microsoft YaHei UI\";\n"
"color: rgb(255, 255, 255);\n"
"border-style: solid;\n"
"border-radius: 15px;\n"
"")
        self.ClearSDbtn.setObjectName("ClearSDbtn")
        self.gridLayout.addWidget(self.ClearSDbtn, 14, 2, 1, 1)
        spacerItem21 = QtWidgets.QSpacerItem(455, 28, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem21, 14, 3, 1, 3)
        spacerItem22 = QtWidgets.QSpacerItem(20, 342, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ClearSDbtn.setText(_translate("MainWindow", "Clear SD"))
