...
class Ui_DataView(object):
    def setupUi(self, DataView):
        ...
        self.gridLayout.addWidget(self.LoadData, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.IDLabel, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.StepsLabel, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.HeartRateLabel, 3, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.TimeLabel, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.ActivityTypeLabel, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_7, 6, 2, 1, 2)
        self.PromptLabel = QtWidgets.QLineEdit(DataView)
        self.PromptLabel.setObjectName("PromptLabel")
        self.gridLayout.addWidget(self.PromptLabel, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.PainLabel, 7, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_9, 8, 2, 1, 2)
        self.PainLevelLabel = QtWidgets.QLineEdit(DataView)
        self.PainLevelLabel.setObjectName("PainLevelLabel")
        self.gridLayout.addWidget(self.PainLevelLabel, 8, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.ButtonSearch, 9, 4, 1, 1)
